<template>
    <div class="login">
        <div class="title_img">
            <img src="../../assets/images/banner04@2x.png">
        </div>
        <div id="content">
            <div class="account">
                <label>找回账号:</label>
            ...
            <div class="account">
                ...
                <input class="self_input" type="text" v-model="verification_code" placeholder="验证码信息">
            ...
            <div class="account">
                <label>验证密码:</label>
                <input type="password" v-model="repeatPassword" placeholder="请再次输入您的密码">
            </div>
            <div class="login_button" @click="submit">
...
export default {
    ...
    methods: {
        ...
        validation(){
            if(this.phoneNo != "" && this.newPassword != "" && this.repeatPassword != "" && this.smsNumber != ""){
                return true;
            }else{
                return false;
            }
        ...
        submit(){
            if(this.validation()){
                axios.post(`${BASE_URL}/user/frontResetPassword`, {
                phone: this.phoneNo,
         ...
         getcode(){
            let codeUrl = `${BASE_URL}/register/sendSms/${this.phoneNo}`;
            axios.get(codeUrl)
            .then(response => {
                // console.log(response);
                if(response.data.success){
